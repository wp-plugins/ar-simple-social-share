...
if (!function_exists('ar_ajax_image_upload') || !function_exists('ar_ajax_image_remove')) {
//Save image via AJAX
    add_action('wp_ajax_ar_ajax_upload', 'ar_ajax_image_upload'); //Add support for AJAX save

    function ar_ajax_image_upload() {
...
//Remove image via AJAX
    add_action('wp_ajax_ar_ajax_remove', 'ar_ajax_image_remove'); //Add support for AJAX save

    function ar_ajax_image_remove() {
        global $wpdb; //Now WP database can be accessed
